 ...
 * $thumb->size_force(200,200)                  // set width and height for thumbnail
...
class My_User_Thumbnail
{
    ...
    {
        $fileAux = explode('.', $imgfile);
        $this->img["format"]= $fileAux[1]; 
    ...
    function size_force($width=100, $height=100){
